          ...
          if (finalPriceWithoutQuantity == priceAfterProductPlanDiscount) {
            ...
            if (discount > 0) {
              discountMessage = '${getTranslated('get', context)} '
                  '${currency}${PriceConverter.calculateDiscountAmount(context, originalPrice, discount, product.discountType ?? "amount")} '
