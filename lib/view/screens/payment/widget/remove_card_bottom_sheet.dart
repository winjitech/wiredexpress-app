...
class RemoveCardBottomSheet extends StatefulWidget {
  ...
  @override
  State<RemoveCardBottomSheet> createState() => _RemoveCardBottomSheetState();
}
  ...
  Widget build(BuildContext context) {
    return Consumer<PaymentProvider>(
      builder: (context, paymentProvider, child) {
        final int userId = Provider.of<ProfileProvider>(context, listen: false)
            .userInfoModel!
            .id!;
        ...
        void updateDetails() {
          ...
          showCustomSnackBar(
              getTranslated('card_deleted_successfully', context), context,
              isError: false);
        }
