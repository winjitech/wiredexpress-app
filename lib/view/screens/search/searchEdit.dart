                        ...
                        child: CustomTextField(
                          ...
                          onSuffixTap: () {
                            if (_searchController.text.length >= 0) {
                              searchProvider.saveSearchAddress('osama');
                          ...
                          onSubmit: (text) {
                            if (_searchController.text.length >= 0) {
                              ...
                              searchProvider.searchProduct('osama', context);
                              Navigator.of(context).push(MaterialPageRoute(builder: (_) => SearchResultScreen(searchString: _searchController.text)));
                            }
                          },
                        ),
                  ...
                  Row(
                    ...
                    children: [
                      Text(
                        ...
                        style: TextStyle(color: ColorResources.COLOR_GREY_BUNKER),
                      ),
                                ...
                                Row(
                                  children: [
                                    ...
                                    Text(
                                      ...
                                      style: TextStyle(color: ColorResources.COLOR_HINT, fontSize: Dimensions.FONT_SIZE_SMALL),
                                    )
                                  ],
                                ),
