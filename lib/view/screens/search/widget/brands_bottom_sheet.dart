  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<SearchProvider>(
        builder: (context, searchProvider, child) {
          List<Brand> _brands = searchProvider.brandsList!;
          List<Brand> _currentList = _searched.isNotEmpty? _searched : _brands;
          return  Stack(
            children: [
              Container(
                width: 550,
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return GestureDetector(
                              onTap: () async {
                                searchProvider.setBrand(_currentList[index]);
                                searchProvider.getBrandCategories(context, _currentList[index].id.toString());
