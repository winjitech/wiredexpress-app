          ...
          child: Container(
            ...
            child: Padding(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                ...
                Image.asset(Images.wallet, color: ColorResources.getPrimaryColor(context), width: 100, height: 100),
                ...
                !order.isLoading ? Row(children: [
                  Expanded(
                    child: TextButton(
                      style: TextButton.styleFrom(
                        ...
                        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10), side: BorderSide(width: 2, color: ColorResources.getPrimaryColor(context))),
                      ),
                  ...
                  Expanded(child: CustomButton(text: getTranslated('yes', context), onTap: () async {
