...
class HistoryCheckoutScreen extends StatefulWidget {
  ...
  @override
  _HistoryCheckoutScreenState createState() => _HistoryCheckoutScreenState();
}
                                                                    ...
                                                                    child: Stack(
                                                                        children: [
                                                                          Container(
                                                                            ...
                                                                            decoration:
                                                                                BoxDecoration(
                                                                              color: index == order.addressIndex ? ColorResources.getScaffoldBackgroundColor(context) : ColorResources.getBackgroundColor(context),
                                                                              borderRadius: BorderRadius.circular(10),
                                                                              border: index == order.addressIndex ? Border.all(color: ColorResources.SCAFFOLD_COLOR, width: 2) : null,
                                                                            ),
                                                                            child:
                                                                                Row(children: [
                                                                              Padding(
                                                                                ...
                                                                                child: Icon(
                                                                                  ...
                                                                                  color: index == order.addressIndex ? ColorResources.getPrimaryColor(context) : ColorResources.getGreyBunkerColor(context),
                                                                                  size: 30,
                                                                                ),
                                                                              ),
                                                                              Expanded(
                                                                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                                                                  ...
                                                                                  Text(address.addressList![index].address!, style: rubikRegular.copyWith(color: ColorResources.getTextColor(context)), maxLines: 1, overflow: TextOverflow.ellipsis),
                                                                                ]),
                                                                              ),
